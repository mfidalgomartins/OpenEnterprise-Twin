...
class PeriodResult(DomainModel):
    ...
    cancelled_orders_count: dict[str, NonNegativeInt]
    fulfilled_orders_count: dict[str, NonNegativeInt]
    otif_orders_count: dict[str, NonNegativeInt]
    fulfilled_evaluation_orders_count: dict[str, NonNegativeInt]
    otif_evaluation_orders_count: dict[str, NonNegativeInt]
    cancelled_evaluation_orders_count: dict[str, NonNegativeInt]
    closing_evaluation_backlog_orders_count: dict[str, NonNegativeInt]
